          ...
          <div className="row">
                      ...
                      <div class="modal-content" id="myModal">
                        <div class="modal-header">
                          ...
                          <div class="modal-body">
                            Recruitments are not open right now. Stay tuned to
                            hear from us!
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-md-6 mb-4 myconatiner">
              <div className="py-5 mx-lg-5">
                <img
                  className="rounded shadow fit-cover heroImage"
                  src={require("./Images/main_page.jpg")}
                  alt=""
                />
              </div>
            </div>
                  ...
                  >
                    <div className="card-body text-center px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title mb-3">
                        Be it Artificial intelligence or Machine learning,
                        Turing AI has got you.
                      </h5>
                      <Link to="turing">
                ...
                <div className="col mb-4">
                  ...
                  >
                    <div className="card-body text-center px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title mb-3">
                        Are you passionate about competitive programming? Code
                ...
                <div className="col mb-4">
                  ...
                  >
                    <div className="card-body text-center px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title mb-3">
                        We, at iDroid help students develop interactive and fun
                        apps based on their ideas.
                      </h5>
                      <Link to="idroid">
                        <button className="btn btn-info btn-sm" type="button">
                          Learn more
                ...
                <div className="col mb-4">
                  ...
                  >
                    <div className="card-body text-center px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title mb-3">
                        We here will teach you and hone you with skills based on
                        these little things that control us:- so-called
                        “Microcontrollers”.
                      </h5>
                      <Link to="electrotech">
                        <button className="btn btn-info btn-sm" type="button">
                ...
                <div className="col mb-4">
                  ...
                  >
                    <div className="card-body text-center px-4 py-5 px-md-5">
                      ...
                      <h5 className="fw-bold card-title mb-3">
                        Do you also have a start-up idea and don’t know what to
                        do next? Well, you are at the right place.
                      </h5>
                      <Link to="ecell">
                        <button className="btn btn-info btn-sm" type="button">
                          Learn more
            ...
            <div className="col mb-4">
              <div className="text-center">
                ...
                <h5 className="fw-bold mb-0">
                  <strong>Dr. Pravin Chandra</strong>
                </h5>
